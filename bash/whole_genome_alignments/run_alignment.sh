...
B_varius=B_varius.masked.fna
C_maculatus=C_maculatus.masked.fna
C_chinensis=C_chinensis.masked.fna
D_carinulata=D_carinulata.masked.fna
D_sublineata=D_sublineata.masked.fna


for SPECIES1 in $A_obtectus $B_siliquastri $B_varius $C_maculatus $C_chinensis $D_carinulata $D_sublineata
do  
