...
sbatch --job-name="Cmac_Bsil_WGA" --output="Cmac_Bsil_WGA.out" $SCRIPT_DIR/whole_pipeline.sh "${ASS_DIR}/C_maculatus_superscaffolded_assembly.fna" "${ASS_DIR}/B_siliquastri.masked.fna"
...
sbatch --job-name="Dcar_Bsil_WGA" --output="Dcar_Bsil_WGA.out" $SCRIPT_DIR/whole_pipeline.sh "${ASS_DIR}/d_carinulata_assembly.fna" "${ASS_DIR}/B_siliquastri.masked.fna"
sbatch --job-name="Bruchidius_WGA" --output="Bruchidius_WGA.out" $SCRIPT_DIR/whole_pipeline.sh "${ASS_DIR}/B_varius_assembly.fna" "${ASS_DIR}/B_siliquastri.masked.fna"