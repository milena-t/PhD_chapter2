...
###########################################
##### taken from the Backström group! #####
###########################################
# https://github.com/EBC-butterfly-genomics-team/Leptidea_chromosome_research2022/blob/main/Scripts/Breakpoint_analysis/identify_chr_breakpoins.sh
###########################################
